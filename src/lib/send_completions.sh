...
send_completions() {
  ...
  echo $'      ;;'
  echo $''
  echo $'    \'tui development git-file-downloader\'*)'
  echo $'      while read -r; do COMPREPLY+=("$REPLY"); done < <(compgen -W "$(_dtools_completions_filter "--help -h")" -- "$cur")'
  echo $'      ;;'
  echo $''
  ...
  echo $'      ;;'
  echo $''
  echo $'    \'tui network network-diagnostic\'*)'
  echo $'      while read -r; do COMPREPLY+=("$REPLY"); done < <(compgen -W "$(_dtools_completions_filter "--help -h")" -- "$cur")'
  echo $'      ;;'
  echo $''
